class PerfThreadsController < ApplicationController
  
  before_filter :get_app, :get_perf_benchmark, :get_perf_test

  # GET /perf_threads/1
  # GET /perf_threads/1.xml
  def show
    @perf_thread = @perf_test.perf_threads.find(params[:id])

    respond_to do |format|
      format.html # show.html.erb
      format.xml  { render :xml => @perf_thread }
    end
  end
